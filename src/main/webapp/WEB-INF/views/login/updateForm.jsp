        ...
        <div class="form-block">
          ...
          onsubmit="return inCheck(this)">
            ...
            <div class="info_2">
              ...
              <div>
                <button type="button" class="cre_btn" onclick="emailCheck(document.frm.email.value)">이메일 변경</button>
            ...
            <div class="info_2">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" id="sample6_address" value="${dto.address1}" name="address1">
                <input type="text" class="form-control" id="sample6_detailAddress" value="${dto.address2}"
                  name="address2">
              </div>
            </div>
